...
namespace mathleethium
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //}
            Console.WriteLine("Округление до целого числа");

            double v = double.Parse(Console.ReadLine());           
            Console.WriteLine("Ближайшее целое число в большую сторону:  " + Math.Ceiling(v));
            Console.WriteLine("Ближайшее целое число в меньшую:    " + Math.Floor(v));
